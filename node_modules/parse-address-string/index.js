...
function looksLikeState(str){
	if (!states) {
		var map = require('parse-address-string/node_modules/parse-address-string/node_modules/parse-address-string/lib/states')
		states = {}
		for (var k in map) {
...
function looksLikeCountry(str){
	if (!countries) {
		var map = require('parse-address-string/node_modules/parse-address-string/node_modules/parse-address-string/lib/countries')
		countries = {}
		for (var k in map) {
			if (map.hasOwnProperty(k)){
